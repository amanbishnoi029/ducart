...
async function createRecord(req, res) {
    if (schema.validate(req.body.password)) {
            ...
            if (err)
                ...
                try {
                    ...
                    mailer.sendMail({
                        ...
                        to: data.email,
                        subject: "Your Account Has Been Created : Team Ducart",
                        text: `
                                    Hello ${data.name},
                    ...
                    error.keyValue ? errorMessage['name'] = "Email Address is Already in Use" : null
        ...
        res.send({ result: "Fail", reason: "Invalid Password! It must Contains atLeast 1 Uppercase Alphabet, 1 Lowercase Alphabet, 1 Digit, doesn't Contains any Spaces and lenght must be from 8-20" })
    }
}
...
async function deleteRecord(req, res) {
    try {
        ...
        if (data) {
            ...
            res.send({ result: "Done", message: "Record id Deleted" })
        }
